...
// published anta-agent package is self-contained: provider requests get long idle
...
// only prevents EventEmitter's unhandled "error" special case from crashing anta-agent.
