import { CONFIG_DIR_NAME, getDisplayAppName } from "../config.ts";
...
function formatProjectTrustPrompt(cwd: string): string {
	return `Trust project folder?\n${cwd}\n\nThis allows ${getDisplayAppName()} to load ${CONFIG_DIR_NAME} settings and resources, install missing project packages, and execute project extensions.`;
}
